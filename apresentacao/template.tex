...
\justifying
		...
		\begin{itemize}
			...
			\item Portanto, para o problema de interesse, esses são os parâmetros recomendados para o algoritmo DE, pois foram aqueles que reproduziram de maneira mais precisa as curvas de efeito dos graus de liberdade sobre a geometria ótima e performance térmica do problema. 
		\end{itemize}
\end{block}
\end{frame}
